...
directory_path = 'zimas_html_downloads3/' #set file path to store html downloads
...
async def main():  
  ...
  buildingpermits_pin_apn_df = pd.read_csv("access_denied_files.csv")
